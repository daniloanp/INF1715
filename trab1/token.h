...
unsigned long Token_GetIntValue( Token t ); //Only aplicable to INT_VAL, otherwise it will through an exception
bool Token_GetBoolValue( Token t ); //Only aplicable to INT_VAL, otherwise it will through an exception
